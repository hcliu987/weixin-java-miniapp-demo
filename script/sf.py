...
class RUN:
    ...
    def couponList(self):
        ...
        for coupon in result['obj']:
            ...
            invalid_date = coupon.get('invalidTm')
            print(f"优惠卷:{coupon_name},过期时间:{invalid_date},手机号:{self.mobile}")
    ...
    def exchange_free(self,ruleCode):
        print('>>>执行兑换23元运费券')
        json_data = {'exchangeType': 'EXCHANGE_SFC',
                    'ruleCode': ruleCode,}# 23yuan的券
    ...
    def DRAGONBOAT_2024_coinStatus(self, END=False):
        ...
        if response.get('success'):
            ...
            for li in accountCurrencyList:
                ...
                if li['currency'] == 'RICH_CARD_GAME':
                    RICH_CARD_GAME = li['balance']
